 ...
 */
export class Player {
    private _firstCard: Position | undefined;
    private _secondCard: Position | undefined;
     ...
     */
    public get firstCard(): Position | undefined {
     ...
     */
    public get secondCard(): Position | undefined {
     ...
     */
    public setFirstCard(position: Position): void {
     ...
     */
    public setSecondCard(position: Position): void {
     ...
     */
    public hasMatchingPair(): boolean {
        return this._firstCard !== undefined && this._secondCard !== undefined;
    }
